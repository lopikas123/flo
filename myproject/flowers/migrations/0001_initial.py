    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=10)),
                ('status', models.CharField(choices=[('pending', 'Принят к работе'), ('in_progress', 'Находится в работе'), ('out_for_delivery', 'В доставке'), ('completed', 'Выполнен')], default='pending', max_length=20)),
